...
member1 = MoviesLibrary("Sakib")
member1.borrow_movie("Inception")
member1.borrow_movie("The Matrix")
member1.view_borrowed_movies()
member1.return_movie("Inception")
member1.return_movie("Pushpa")
member1.view_borrowed_movies()

'''Output'''
"""Inception has been borrowed by Sakib
The Matrix is not available in the library
Sakib has borrowed: ['Inception']
Inception has been returned to the library by Sakib
Pushpa was not borrowed by Sakib
Sakib has borrowed: []:"""